...
| ----------------------------- | ----------------------------------------- | --------------------- |
| `replicas`                    | Number of etcd replicas (use odd numbers) | `3`                   |
| `image.repository`            | etcd image repository                     | `quay.io/coreos/etcd` |
| `image.tag`                   | etcd image tag                            | `v3.5.17`             |
...
| `auth.enabled`                | Enable RBAC authentication                | `false`               |
| `tls.enabled`                 | Enable TLS for client communication       | `false`               |
| `service.type`                | Service type for client access            | `ClusterIP`           |
...
| Parameter                      | Description                          | Default            |
| ------------------------------ | ------------------------------------ | ------------------ |
| `etcd.initialClusterToken`     | Cluster token for isolation          | `etcd-cluster`     |
| `etcd.initialClusterState`     | Initial cluster state (new/existing) | `new`              |
| `etcd.autoCompactionRetention` | Auto compaction retention (hours)    | `1`                |
| `etcd.snapshotCount`           | Snapshot count                       | `10000`            |
| `etcd.quotaBackendBytes`       | Backend quota (bytes)                | `8589934592` (8GB) |
| `etcd.heartbeatInterval`       | Heartbeat interval (ms)              | `100`              |
| `etcd.electionTimeout`         | Election timeout (ms)                | `1000`             |
