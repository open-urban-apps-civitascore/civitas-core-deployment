...
The chart pins a floating `stable-alpine` tag so the demo cannot break when a
version is retired. A production add-on should pin an exact version or digest.
